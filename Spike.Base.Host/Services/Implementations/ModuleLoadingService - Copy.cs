...
//        private static List<Type> RegisterNewServicesInNewDIScope(IServiceCollection serviceCollection, IEnumerable<Type> assemblyTypes)
//        {
...
//                serviceCollection.AddSingleton(serviceType, tInterface);
